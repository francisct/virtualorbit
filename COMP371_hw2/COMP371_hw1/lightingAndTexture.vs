...
void main () {
	...
	Normal_cameraspace = ( view_matrix * model_matrix * vec4(vertexNormal_modelspace,0)).xyz; // Only correct if ModelMatrix does not scale the model ! Use its inverse transpose if not.
